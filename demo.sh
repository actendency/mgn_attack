...
#CUDA_VISIBLE_DEVICES=0,1 python3 main.py --reset --datadir ../../Dataset/Market-1501-v15.09.15/ --batchid 16 --batchtest 32 --test_every 4 --epochs 160 --decay_type step_120_140 --loss 1*CrossEntropy+2*Triplet --margin 0.3 --re_rank --random_erasing --save MGN_adam --nGPU 2  --lr 2e-4 --optimizer ADAM
...
CUDA_VISIBLE_DEVICES=0,1 python3 main.py --datadir ../../Dataset/Market-1501-v15.09.15/ --batchid 16 --batchtest 32 --test_every 50 --epochs 400 --decay_type step_320_380 --loss 2*CrossEntropy+0*Triplet --margin 1.2 --save adam_1 --nGPU 2  --lr 2e-4 --optimizer ADAM --random_erasing --reset --re_rank --amsgrad
