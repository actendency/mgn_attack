...
class Data:
    def __init__(self, args):
        ...
        if args.data_test in ['Market1501']:
            ...
            self.attackset = getattr(module, args.data_test)(args, test_transform, 'attack')
        ...
        self.attack_loader = dataloader.DataLoader(self.attackset, batch_size=45, num_workers=args.nThread)
